...
const (
	...
	DC   		 ConferenceAbbreviation = "DC"
	LADC 		 ConferenceAbbreviation = "LADC"
)
...
var ConferenceAbbreviationToName = map[ConferenceAbbreviation]string{
	...
	LADC:         "Latin-American Symposium on Dependable and Secure Computing",
}
...
var ResearchPapers []ResearchPaper = []ResearchPaper{
	...
	{
		Handle:         "asymmetric-trust",
		Name:           "Asymmetric Distributed Trust",
		Conference:     DC,
		ConferenceYear: 2024,
		Authors:        []string{"Orestis Alpos", "Christian Cachin", "Björn Tackmann", "Luca Zanolini"},
		Url:            "https://arxiv.org/pdf/1906.09314.pdf",
		Tags:           []Tag{CONSENSUS},
		Citations:      15,
	},
	{
		Handle:         "thetacrypt-ladc",
		Name:           "Thetacrypt: A Distributed Service for Threshold Cryptography",
		Conference:     LADC,
		ConferenceYear: 2025,
		Authors:        []string{"Mariarosaria Barbaraci", "Michael Senn", "Nicolas Schmid", "Orestis Alpos", "Christian Cachin"},
		Url:            "https://arxiv.org/pdf/2502.03247.pdf",
		Tags:           []Tag{},
		Citations:      2,
	},
	{
		Handle:         "securing-lightning-channels",
		Name:           "Securing Lightning Channels against Rational Miners",
		Conference:     CCS,
		ConferenceYear: 2024,
		Authors:        []string{"Lukas Aumayr", "Zeta Avarikioti", "Matteo Maffei", "Subhra Mazumdar"},
		Url:            "https://eprint.iacr.org/2024/826.pdf",
		Tags:           []Tag{LIGHTNING_NETWORK, PAYMENT_CHANNELS},
		Citations:      17,
	},
	{
		Handle:         "thunderdome",
		Name:           "Thunderdome: Timelock-Free Rationally-Secure Virtual Channels",
		Conference:     USENIX,
		ConferenceYear: 2025,
		Authors:        []string{"Zeta Avarikioti", "Yuheng Wang", "Yuyi Wang"},
		Url:            "https://arxiv.org/pdf/2501.14418.pdf",
		Tags:           []Tag{PAYMENT_CHANNELS, TIMELOCK},
		Citations:      3,
	},
	{
		Handle:         "cobra-strategyproof",
		Name:           "CoBRA: A Universal Strategyproof Confirmation Protocol for Quorum-based Proof-of-Stake Blockchains",
		Conference:     ARXIV,
		ConferenceYear: 2025,
		Authors:        []string{"Zeta Avarikioti", "Eleftherios Kokoris Kogias", "Ray Neiheiser", "Christos Stefo"},
		Url:            "https://arxiv.org/pdf/2503.16783.pdf",
		Tags:           []Tag{CONSENSUS, PROOF_OF_STAKE},
		Citations:      2,
	},
	{
		Handle:         "l2-security-framework",
		Name:           "A Security Framework for General Blockchain Layer 2 Protocols",
		Conference:     ARXIV,
		ConferenceYear: 2025,
		Authors:        []string{"Zeta Avarikioti", "Matteo Maffei", "Yuheng Wang"},
		Url:            "https://arxiv.org/pdf/2504.14965.pdf",
		Tags:           []Tag{},
		Citations:      2,
	},
	{
		Handle:         "composable-game-theory",
		Name:           "A Composable Game-Theoretic Framework for Blockchains",
		Conference:     ARXIV,
		ConferenceYear: 2025,
		Authors:        []string{"Zeta Avarikioti", "Georg Fuchsbauer", "Pim Keer", "Matteo Maffei", "Fabian Regen"},
		Url:            "https://arxiv.org/pdf/2504.18214.pdf",
		Tags:           []Tag{},
		Citations:      3,
	},
	{
		Handle:         "calyx",
		Name:           "Calyx: Privacy-Preserving Multi-Token Optimistic-Rollup Protocol",
		Conference:     ARXIV,
		ConferenceYear: 2025,
		Authors:        []string{"Dominik Apel", "Zeta Avarikioti", "Matteo Maffei", "Yuheng Wang"},
		Url:            "https://arxiv.org/pdf/2510.00164.pdf",
		Tags:           []Tag{PRIVACY},
		Citations:      1,
	},
	{
		Handle:         "bitpriv",
		Name:           "BitPriv: A Privacy-Preserving Protocol for DeFi Applications on Bitcoin",
		Conference:     EPRINT,
		ConferenceYear: 2025,
		Authors:        []string{"Ioannis Alexopoulos", "Zeta Avarikioti", "Paul Gerhart", "Matteo Maffei", "Dominique Schröder"},
		Url:            "https://eprint.iacr.org/2025/1575.pdf",
		Tags:           []Tag{BITCOIN, PRIVACY, DEFI},
		Citations:      0,
	},
	{
		Handle:         "bitcoin-ipc",
		Name:           "Bitcoin-IPC Whitepaper: Scaling Bitcoin with a Network of Proof-of-Stake Subnets",
		Conference:     ARXIV,
		ConferenceYear: 2025,
		Authors:        []string{"Marko Vukolić", "Orestis Alpos", "Jakov Mitrovski", "Themis Papameletiou", "Nikola Ristić", "Dionysis Zindros"},
		Url:            "https://arxiv.org/pdf/2512.23439.pdf",
		Tags:           []Tag{BITCOIN, PROOF_OF_STAKE, INTEROPERABILITY},
		Citations:      0,
	},
	{
		Handle:         "cardinal",
		Name:           "Cardinal: Bridging Bitcoin with Ownership Preservation",
		Conference:     EPRINT,
		ConferenceYear: 2025,
		Authors:        []string{"Lukas Aumayr", "Jesus Diaz", "Dimitar Jetchev", "Aggelos Kiayias"},
		Url:            "https://eprint.iacr.org/2025/2196.pdf",
		Tags:           []Tag{BITCOIN, INTEROPERABILITY},
		Citations:      0,
	},
	{
		Handle:         "censorship-resistant-auctions",
		Name:           "Censorship-Resistant Sealed-Bid Auctions on Blockchains",
		Conference:     EPRINT,
		ConferenceYear: 2025,
		Authors:        []string{"Orestis Alpos", "Lioba Heimbach", "Kartik Nayak", "Sarisht Wadhwa"},
		Url:            "https://eprint.iacr.org/2025/2127.pdf",
		Tags:           []Tag{FAIRNESS, PRIVACY},
		Citations:      1,
	},
	{
		Handle:         "wonderboom",
		Name:           "Wonderboom: Efficient, and Censorship-Resilient Signature Aggregation for Million Scale Consensus",
		Conference:     ARXIV,
		ConferenceYear: 2026,
		Authors:        []string{"Zeta Avarikioti", "Ray Neiheiser", "Krzysztof Pietrzak", "Michelle X. Yeo"},
		Url:            "https://arxiv.org/pdf/2602.06655.pdf",
		Tags:           []Tag{CONSENSUS, DECENTRALIZATION},
		Citations:      0,
	},
}
