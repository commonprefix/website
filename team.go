...
var Members map[string]TeamMember = map[string]TeamMember{
	...
	"bernardo": {
		...
		Desc: template.HTML(`
            ...
            scientific journals and conferences. Among his main contributions is the first provably secure protocol
            for proof-of-stake blockchains. Besides academic activities, he has been a consultant for a number of industry projects
